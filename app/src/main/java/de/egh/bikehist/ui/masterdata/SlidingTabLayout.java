...
public class SlidingTabLayout extends HorizontalScrollView {
	...
	public static final String TAG = SlidingTabLayout.class.getSimpleName();
	...
	protected void onAttachedToWindow() {
		...
		if (mViewPager != null) {
			callbacks.onPageSet(mViewPager.getCurrentItem());
	...
	public interface Callbacks {
		...
		/** Called with the new position, after tab has changed. */
		void onPageSet(int position);
	}
